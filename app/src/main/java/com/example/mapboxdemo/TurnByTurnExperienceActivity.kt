...
import com.example.mapboxdemo.databinding.ActivityTurnByTurnExperienceBinding
    ...
    private fun findRoute(destination: Point) {
        ...
        mapboxNavigation.requestRoutes(
            RouteOptions.builder()
                ...
                .coordinatesList(
                    listOf(
                        Point.fromLngLat(72.6250918, 23.0588118),
                        Point.fromLngLat(72.5461585, 23.0763406)
                    )
                )
